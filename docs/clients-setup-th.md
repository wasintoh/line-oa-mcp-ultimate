...
| **Claude Code / Codex** | อยู่ใน terminal/โปรเจค — เด่นตอน **dev LINE Mini App แล้วเทสได้เลย** เช่น จัดการ LIFF app (`manage_liff_app`) + จัดการร้าน LINE Shopping (สินค้า/ออเดอร์) → สั่ง broadcast ทดสอบในเซสชันเดียว |
